...
void IoMod::writeText(const std::string& msg, int x, int y, SDL_Color myColor) const
{
    SDL_Surface* surface = TTF_RenderText_Solid(font, msg.c_str(), myColor);
    SDL_Texture* texture = SDL_CreateTextureFromSurface(renderer, surface);
...
void IoMod::deathText(const std::string& msg, int x, int y, SDL_Color myColor) const
{
    SDL_Surface* surface = TTF_RenderText_Solid(font, msg.c_str(), myColor);
    SDL_Texture* texture = SDL_CreateTextureFromSurface(renderer, surface);
